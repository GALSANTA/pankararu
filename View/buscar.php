	...
	<tbody>
		<?php foreach ($socios as $socio):?>
			<tr>
				...
				<td>
					<a href="<?php echo BASE_URL;?>buscar/explorar/<?php echo $socio['id_socio'] ?>" class="btn-floating blue">
						<i class="tiny material-icons">search</i>
					</a>
					<a href="<?php echo BASE_URL;?>buscar/editar/<?php echo $socio['id_socio'] ?>" class="btn-floating green" >
						<i class="tiny material-icons">create</i>
					</a>
					<a href="javascript:;" class="btn-floating red" onclick="excluir('<?php echo $socio['id_socio'] ?>')">
